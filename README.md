...
**This proxy does not manipulate the contents of any packets, it only reads packet data and pieces together packet fragments from the server to be sent over WebSockets. This proxy was not made with the intent of performing any malicious acts and does not purposely allow someone to such.**
